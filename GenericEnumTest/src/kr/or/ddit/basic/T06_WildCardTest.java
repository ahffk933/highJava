...
2. Type parameters 는 하한 제한만 가능 (와일드 카드는 상한, 하한 가능(super, extends))
...
class Juicer{
	...
	//static <T extends Fruit> void makeJuice(FruitBox<T> box) { // 지네릭 메서드(제한된 타입 파라미터) 이용 (범위제한)
 ...
 * 과일상자
 */
class FruitBox<T>{  //generic class
