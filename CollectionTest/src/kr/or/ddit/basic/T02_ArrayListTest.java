...
public class T02_ArrayListTest {
	...
	public static void main(String[] args) {
		...
		list1.remove("bbb"); //데이터 값 (한개씩 지울 수 있슴)
		System.out.println("bbb 삭제후 : " + list1);
		System.out.println("===========================");
		
		// 제네릭을 지정하여 선언할 수 있다. type safety를 위해 /compiler가 보장/ 캐스팅할 필요x
		...
		//index 값을 알고싶을때, 데이터가 많을때 indexOf로 index값 먼저 찾고 get으로 불러오는 방법이 있다는
