...
public class Controller {
	...
	@FXML public void clickBarChart(ActionEvent event) {
		...
		for(int i = 0 ; i < list.size() ; i++)
		{
			ser2.getData().add(new Data<String, Number>(list.get(i).getName(), list.get(i).getMath()));
		}
		...
		for(int i = 0 ; i < list.size() ; i++)
		{
			ser3.getData().add(new Data<String, Number>(list.get(i).getName(), list.get(i).getEng()));
		}
