...
//데이터를 셋팅만 하는 쓰레드
class ProducerThread extends Thread{   //producer -> 생산자역
...
class ConsumerThread extends Thread{
	...
	public void run() {
		for(int i=1; i<=10; i++) {
			String data = dataBox.getData();  //10번 세팅된거 가져오는
